...
public abstract class RegionCuboid {
    ...
    public RegionCuboid(final Location pos1, final Location pos2) {
    ...
    public double getDistance() {
        return this.getPos1().distance(this.getPos2());
    }

    public double getDistanceSquared() {
        return this.getPos1().distanceSquared(this.getPos2());
    }
